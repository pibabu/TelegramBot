...
class OutputModel(BaseModel):
    assistant_answer: str = Field(description="Channel for coordinating with user about example creation and receiving feedback")
    example_questions: List[str] = Field(description="Three Q&A examples demonstrating the chosen personality style")
    keep_state: bool = Field(description="Set to False ONLY if user explicitly APPROVES examples")
